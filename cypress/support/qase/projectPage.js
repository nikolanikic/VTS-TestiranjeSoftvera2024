class ProjectPage {
  ...
  createNewProject() {
    ...
    this.newProjectNameInput().type('Project_022');
    this.newProjectCodeInput().clear().type('022');
    this.newProjectDescInput().type("Milica Velickovic");
